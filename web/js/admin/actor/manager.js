...
(function(nsp){
	...
	*/
	...
	nsp.fn.ActorRepository = (function(){
		...
		ActorRepository.prototype.customRequest = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			this.request({
	  				url:`/fr/admin/actors/${event.type}/${this.current.id}`,
	  				method:"POST",
		...
		ActorRepository.prototype.customCountryRequest = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			this.request({
	  				url:`/fr/admin/actors/${this.current.id}/country/${event.type}`,
	  				method:"POST",
		...
		ActorRepository.prototype.uploadImage = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			...
	  			this.request({
	  				...
	  				url:`/fr/admin/actors/${this.current.id}/image/${event.type}`,
	  				method:"POST",
	  				data:formData,
	  				processData: false,
	  				cache: false,
	...
	nsp.fn.ActorView = (function(){
		...
		ActorView.prototype.renderSelectedData = function(view){
