	...
	nsp.fn.DirectorRepository = (function(){
		...
		DirectorRepository.prototype.customRequest = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			this.request({
	  				url:`/fr/admin/directors/${event.type}/${this.current.id}`,
	  				method:"POST",
		...
		DirectorRepository.prototype.customCountryRequest = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			this.request({
	  				url:`/fr/admin/directors/${this.current.id}/country/${event.type}`,
	  				method:"POST",
		...
		DirectorRepository.prototype.uploadImage = function(event){
			...
			return new Promise((resolve,reject)=>{
	  			...
	  			this.request({
	  				...
	  				url:`/fr/admin/directors/${this.current.id}/image/${event.type}`,
	  				method:"POST",
	  				data:formData,
	  				processData: false,
	  				cache: false,
