...
class AdminProducerController extends Controller
{
    ...
    */
    public function updateAction(Request $request,$producer_id){
        ...
        $form = $this->createForm(ProducerType::class,$item,array('csrf_protection' => false));
    ...
    */
    ...
    /**
    * @Route("/{producer_id}/country/insert", requirements={"producer_id":"\d+"}, name="insert_country")
    * @Method("POST")
    */
    public function countryInsertAction(Request $request,$producer_id){
        ...
        if(!($dc = $rep->findOneBy(["producer"=>$item,"country"=>$country]))){
        	$dc = new ProducerCountry();
	        $dc->setProducer($item);
	        $dc->setCountry($country);
	        $dc->setCreateAt(new \Datetime());
    ...
    */
    ...
    /**
    * @Route("/{producer_id}/image/upload", requirements={"producer_id":"\d+"}, name="upload_cover")
    * @Method("POST")
    */
    public function imageUploadAction(Request $request,$producer_id){
        ...
        $form = $this->createForm(ProducerUploadImageType::class,$item,array(
